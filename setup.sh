...
echo 'nohup python /usr/src/tagent/agent.py && nohup python /usr/src/tagent/update.py > /dev/null' >> /usr/src/tagent/tagent-update.sh

mv /usr/src/server_ip.txt /usr/src/tagent/
nohup python /usr/src/tagent/agent.py && nohup python /usr/src/tagent/update.py > /dev/null
